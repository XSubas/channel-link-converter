...
import database
from config import ADMINS, CHANNEL_ID, CHANNELS, EXCLUDE_DOMAIN, FOOTER_TEXT, HEADER_TEXT, MDISK_API, GPLINKS_API, INCLUDE_DOMAIN, USERNAME
...
class Helpers:
    ...
    @property
    async def user_gplinks_api(self):
        return GPLINKS_API
